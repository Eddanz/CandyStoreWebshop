...
namespace CandyStoreWebshop.Migrations
{
    ...
    [Migration("20240906125425_Initial Creation")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CandyStoreWebshop.Models.Candy", b =>
                {
            ...
            modelBuilder.Entity("CandyStoreWebshop.Models.Category", b =>
                {
                    b.Property<int>("CategoryId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CandyStoreWebshop.Models.Order", b =>
                {
            ...
            modelBuilder.Entity("CandyStoreWebshop.Models.OrderDetails", b =>
                {
            ...
            modelBuilder.Entity("CandyStoreWebshop.Models.ShoppingCartItem", b =>
                {
            ...
            modelBuilder.Entity("CandyStoreWebshop.Models.Candy", b =>
                {
                    b.HasOne("CandyStoreWebshop.Models.Category", "Category")
                        .WithMany("Candies")
            ...
            modelBuilder.Entity("CandyStoreWebshop.Models.OrderDetails", b =>
                {
                    b.HasOne("CandyStoreWebshop.Models.Candy", "Candy")
                        .WithMany()
                        .HasForeignKey("CandyId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("CandyStoreWebshop.Models.Order", "Order")
                        .WithMany()
